...
class AdapterDaDatRoom(var context: Context, var list: List<Room>) :  RecyclerView.Adapter<AdapterDaDatRoom.Viewholider>() {

    var databaseReference: DatabaseReference? = null

    class Viewholider (var itemView : View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onBindViewHolder(holder: Viewholider, position: Int) {
        ...
        databaseReference!!.orderByChild(room.statusRoom.toString()).equalTo(true)
